...
/*   Updated: 2024/08/12 14:14:43 by vsoltys          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Server::send_private_msg(std::string msg , Client who_send, Client who_receive)
{
	...
	std::string final_msg = ":" + who_send.getNickname() +"!" +who_send.getUsername() + "@" + who_send.getUsername() +" PRIVMSG " + who_send.getUsername() + " :"+ msg + "\r\n";
